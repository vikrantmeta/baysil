...
class CertificationsControllerTest < ActionController::TestCase
  ...
  test "should create certification" do
    assert_difference('Certification.count') do
      post :create, certification: { authority: @certification.authority, certification_link: @certification.certification_link, date_from: @certification.date_from, date_to: @certification.date_to, license_number: @certification.license_number, name: @certification.name }
    end
  ...
  test "should update certification" do
    put :update, id: @certification, certification: { authority: @certification.authority, certification_link: @certification.certification_link, date_from: @certification.date_from, date_to: @certification.date_to, license_number: @certification.license_number, name: @certification.name }
    assert_redirected_to certification_path(assigns(:certification))
  end
